...
public class HomeUIManger : MonoBehaviour
{
    ...
    void Setup()
    {
        ...
        ExitButtonUpgrade.onClick.AddListener(() => {SoundManager.Play("ButtonSelect");});
        AcceptUpgradeButton.onClick.AddListener(() => {SoundManager.Play("ButtonSelect");});
        LeftButton.onClick.AddListener(() => {SoundManager.Play("ButtonSelect");});
        RightButton.onClick.AddListener(() => {SoundManager.Play("ButtonSelect");});
